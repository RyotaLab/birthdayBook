        ...
        ZStack{
            ...
            if showContent {
                ContentView()
                    ...
                    .environmentObject(NewBirthdayBook.NotificationModel())
                    .environmentObject(NewBirthdayBook.AdmobInterstitialManager())
                    //.environmentObject(NewBirthdayBook.IconChange())
