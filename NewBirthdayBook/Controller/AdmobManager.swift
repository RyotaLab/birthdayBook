...
//  NewBirthdayBook
//
//AppID：ca-app-pub-8712548779253226~2959223643
//広告ID：ca-app-pub-8712548779253226/6922519384
...
class AdmobInterstitialManager: NSObject, ObservableObject, GADFullScreenContentDelegate {
    ...
    @Published var AdsOpenCount: Int = 1
    // インタースティシャル広告が格納される
    ...
    func loadInterstitial() {
        GADInterstitialAd.load(withAdUnitID: "ca-app-pub-8712548779253226/6922519384", request: GADRequest()) { (ad, error) in
            if let _ = error {
                print("読み込み失敗")
