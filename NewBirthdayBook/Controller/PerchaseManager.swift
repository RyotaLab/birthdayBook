...
class PurchaseManager: ObservableObject {
    ...
    //productIdの列挙
    let ConsumableProductIds = ["tanabi.NewBirthdayBook.donation.item1", "tanabi.NewBirthdayBook.donation.item2" , "tanabi.NewBirthdayBook.donation.item3"]
    let NonConsumableProductIds = ["tanabi.NewBirthdayBook.premiumplan"]
